console.log("Welcome to exercise 5 solution");
...
function populate(){
    ...
    results.forEach(element => {
        html += `<li class="list-group-item list-group-item-light">One of the defination of example is ${element.definition} </li>`;
    });
